...
<body>
    <header>
        <h1> <img src="<?php echo e(asset('icons/logo-educhek-v2.png')); ?>" alt="">educheck</h1>
        <div class="tagline">
   ...
   <section>
       <div class="slider">
           <div class="slides">
               ...
               <img src="<?php echo e(asset('images/image-slider-5.png')); ?>" alt="">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="box-file">
            ...
            <div id="drop-area-dokumen" class="drop-area">
                <img src="<?php echo e(asset('icons/circle-arrow-up-solid-full.svg')); ?>" alt=""> 
        ...
        <div class="box-bukti">
            <strong>Upload Bukti Transfer</strong><br><br>
             <div class="payment">
                ...
                <div class="qris">
                    <img src="<?php echo e(asset('icons/educhek-qris.png')); ?>" alt="">
                </div>
            </div>
            <br><br>

            <div id="drop-area-bukti" class="drop-area">
                <img src="<?php echo e(asset('icons/images-solid-full.svg')); ?>" alt=""> 
                <p>Pilih atau seret file ke sini</p>
            ...
            <div id="contact-person">
                <div class="contact-box">
                    <div class="icons-contact">
                        <img src="<?php echo e(asset('icons/phone-solid-full.svg')); ?>" alt=""> 
                    </div>
                    <p>082377179728</p>
                </div>
                <div class="contact-box">
                    <div class="icons-contact">
                        <img src="<?php echo e(asset('icons/envelope-solid-full.svg')); ?>" alt=""> 
                </div>
                <p>sulaimanedi14@gmail.com</p>
            </div>
            <div class="contact-box">
                <div class="icons-contact">
                    <img src="<?php echo e(asset('icons/clock-regular-full.svg')); ?>" alt=""> 
                </div>
...
<?php /**PATH /home/onoy/eduche/resources/views/index.blade.php ENDPATH**/ ?>